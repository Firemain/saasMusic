...
import { TIMELINE_BOUNDING_CHANGED, TIMELINE_PREFIX, filter, subject } from "@designcombo/events";
import useStore from "@/store/store";
import { handleEvents } from "@designcombo/timeline";
import Playhead from "./playhead";
import { Audio } from "./items";
import { useCurrentPlayerFrame } from "@/hooks/use-current-frame";
//import le fichier css timeline.css pour le style
import "./timeline.css";
...
const Timeline = () => {
  ...
  }, [currentFrame, playerRef, fps, scale.zoom, scrollLeft]);
